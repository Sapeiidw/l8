                            ...
                            <div class="col-3 mb-4">
                                ...
                                <div class="float-right d-flex justify-content-around" style="width:50px;">
                                    ...
                                    if ($_SESSION['role'] == "admin") {
                                        ...
                                        <a href="'.BASEPATH."course/".$course['id'].'/delete" class="text-danger text-center">';
                                    } else {
                                        echo '<a href="'.BASEPATH."course-member/".$course['member_id'].'/delete" class="text-danger text-center ml-auto">';
                                    }
