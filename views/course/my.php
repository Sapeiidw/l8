<div class="card">
    <div class="card-header">
        course
        <a href="<?= BASEPATH."course/create"?>" class="btn btn-outline-primary float-right">
            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-plus" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
            </svg>
        </a>
        <a href="<?= BASEPATH."course-member/create" ?>" class="btn btn-primary btn-sm d-inline">join</a>
    </div>
                    ...
                    foreach ($data as $course) {
                        ...
                        <div class="col-3 mb-4">
                            ...
                            <div class="float-right d-flex justify-content-around" style="width:50px;">
                                ...
                                <a href="'.BASEPATH."course-member/".$course['member_id'].'/delete" class="text-danger text-center">
