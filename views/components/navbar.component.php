    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="<?= BASEPATH ?>login">Login</a>
          <a class="dropdown-item" href="<?= BASEPATH ?>logout">Logout</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="<?= BASEPATH ?>user/<?= $_SESSION['id'] ?>"><?= $_SESSION['username']; ?></a>
        </div>
      </li>
